...
public class Common {
	...
	public static boolean head_check(long head, int check_layer) {
		/**
		 * <PRE>
	 ...
	 */
	public static int decode_header(Frame fr, long newhead) {
		...
		case 3:
			if (fr.framesize > MAX_INPUT_FRAMESIZE) {
				System.err.printf("Frame BAG_SIZE too big.\n");
	...
	public static void print_header(Frame fr) {
	...
	public static void print_header_compact(Frame fr) {
	...
	public static int getbits(mpstr_tag mp, int number_of_bits) {
		long rval;
	...
	public static int getbits_fast(mpstr_tag mp, int number_of_bits) {
		long rval;
	...
	public static int set_pointer(mpstr_tag mp, int backstep) {
