...
public class GainAnalysis {
	...
	/**
	 * numerator / denominator = time slice BAG_SIZE [s]
	 */
	 ...
	 * point to real data
	 */
	private static void filterYule(float[] input, int inputPos, float[] output,
			int outputPos, int nSamples, float[] kernel) {
	...
	private static void filterButter(float[] input, int inputPos,
			float[] output, int outputPos, int nSamples, float[] kernel) {
	 ...
	 *         not
	 */
	private static int ResetSampleFrequency(ReplayGain rgData,
			long samplefreq) {
	...
	public static int InitGainAnalysis(ReplayGain rgData,
			long samplefreq) {
	 ...
	 * square
	 */
	private static double fsqr(double d) {
		return d * d;
	}

	public static int AnalyzeSamples(ReplayGain rgData,
			float[] left_samples, int left_samplesPos,
			float[] right_samples, int right_samplesPos, int num_samples,
			int num_channels) {
		int curleft;
		float[] curleftBase;
		int curright;
	...
	private static float analyzeResult(int[] Array, int len) {
		int i;
	...
	public static float GetTitleGain(ReplayGain rgData) {
