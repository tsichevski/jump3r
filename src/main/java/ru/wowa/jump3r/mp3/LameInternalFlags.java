...
public class LameInternalFlags {
	 ...
	 * optional ID3 tags
	 */
	public ID3TagSpec tag_spec = new ID3TagSpec();
	 ...
	 */
	public ATH ATH = new ATH();

	public PSY PSY = new PSY();
	...
	public ReplayGain rgdata = new ReplayGain();
