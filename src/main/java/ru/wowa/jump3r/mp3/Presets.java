...
public class Presets {
	...
	private static void apply_vbr_preset(LameGlobalFlags gfp, int a,
			int enforce) {
		VBRPresets[] vbr_preset = gfp.VBR == VbrMode.vbr_rh ? vbr_old_switch_map
				: vbr_psy_switch_map;
	...
	private static int apply_abr_preset(LameGlobalFlags gfp, int preset,
			int enforce) {
	...
	public static int apply_preset(LameGlobalFlags gfp, int preset,
			int enforce) {
	 ...
	 * 9 = lowest
	 */
	public static int lame_set_VBR_q(LameGlobalFlags gfp, int VBR_q) {
		int ret = 0;
