...
public class LameGlobalFlags {
	...
	public @Nullable ShortBlock short_blocks;

	/**
	 * use temporal masking effect
	 */
	public @Nullable Boolean useTemporal;
	...
	/**************************************************************************/
	public LameInternalFlags internal_flags = new LameInternalFlags();
