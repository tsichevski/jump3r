...
public class NewMDCT {
	 ...
	 */
	private static void window_subband(float[] x1, int x1Pos, float a[]) {
		int wp = 10;
	 ...
	 * New layer3
	 */
	private static void mdct_short(float[] inout, int inoutPos) {
		for (int l = 0; l < 3; l++) {
	...
	static void mdct_long(float[] out, int outPos, float[] in) {
		float ct, st;
		{
	...
	public static void mdct_sub48(LameInternalFlags gfc, float[] w0,
			float[] w1) {
		float[] wk = w0;
		int wkPos = 286;
