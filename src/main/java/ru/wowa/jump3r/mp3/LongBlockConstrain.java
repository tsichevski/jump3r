...
import ru.wowa.jump3r.mp3.VBRQuantize.algo_t;

class LongBlockConstrain implements VBRQuantize.alloc_sf_f {
	/**
	 * 
	 */
	private VBRQuantize vbrQuantize;
