...
public class Encoder {
	...
	public void setModules(BitStream bs, PsyModel psy, QuantizePVT qupvt,
			VBRTag vbr) {
		this.bs = bs;
		this.psy = psy;
		this.vbr = vbr;
	 ...
	 */
	private static void adjust_ATH(LameInternalFlags gfc) {
		...
		if (max_pow > 0.03125) { /* ((1 - 0.000625)/ 31.98) from curve below */
			...
			float adj_lim_new = 31.98f * max_pow + 0.000625f;
	 ...
	 * </PRE>
	 */
	private static void updateStats(LameInternalFlags gfc) {
		int gr, ch;
	...
	private static void lame_encode_frame_init(LameGlobalFlags gfp,
			float inbuf[][]) {
	 ...
	 * 
	 * 
	 * 	    inbuf = buffer of PCM data BAG_SIZE=MP3 framesize
	...
	private static float fircoef[] = { -0.0207887f * 5, -0.0378413f * 5,
			-0.0432472f * 5, -0.031183f * 5, 7.79609e-18f * 5, 0.0467745f * 5,
			0.10091f * 5, 0.151365f * 5, 0.187098f * 5 };

	public int lame_encode_mp3_frame(LameGlobalFlags gfp,
