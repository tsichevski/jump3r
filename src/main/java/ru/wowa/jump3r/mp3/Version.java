...
public class Version {
	 ...
	 */
	public static String getLameShortVersion() {
	 ...
	 */
	public static String getLameVeryShortVersion() {
		// Adding date and time to version string makes it harder for output
	 ...
	 */
	public static String getPsyVersion() {
	 ...
	 */
	public static String getLameUrl() {
		return LAME_URL;
	}
	 ...
	 * @return "32bits"
	 */
	public static String getLameOsBitness() {
		return "32bits";
	}
